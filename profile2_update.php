  ...
  <section class="home">
    ...
    <form action="INCLUDES/update.inc.php" method="POST" autocomplete="off" class="form-container sign-up profile"
      ...
      <div class="step-form">
        ...
        <div class="input-box">
          <input type="file" name="hobby-photo" id="hobby-photo" value="<?php echo $data["hobbyphoto"] ?? ""; ?>"
            required>
          <input type="hidden" name="old-photo" id="old-photo" value="<?php echo $data["hobbyphoto"] ?? ""; ?>"
            required>
